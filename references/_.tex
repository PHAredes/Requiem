...
\begin{itemize}[leftmargin=*]
\item \textbf{Zhang, Tesla} (2021). \href{https://doi.org/10.1145/3471875.3472991}{``A Simpler Encoding of Indexed Types.''} \emph{TyDe 2021}. \href{https://arxiv.org/abs/2103.15408}{[arXiv]}

\textit{Annotation:} Primary reference for Requiem's indexed-family encoding, constructor availability analysis, and pattern matching against indices.

\item \textbf{Zhang, Tesla} (2021). \href{https://arxiv.org/abs/2105.14840}{``Elegant Elaboration with Function Invocation.''}

\textit{Annotation:} Primary reference for Requiem's elaboration strategy, especially exact application and surface-to-core invocation structure.

\item \textbf{Zhang, Tesla} (2023). \href{https://arxiv.org/abs/2309.14187}{``Two Tricks to Trivialize Higher-Indexed Families.''}

\textit{Annotation:} Primary reference for simplifying higher-indexed family encodings and understanding the practical shape of advanced indexed data in Requiem.
